...
PHRASES_TO_CHECK_NOT = [gl.Twenty20.HOLDING_PHRASE]
...
def attemptconnection(client, url):
    if client.establishconnection(url, phrases_to_check=PHRASES_TO_CHECK, phrases_to_check_not=PHRASES_TO_CHECK_NOT):
        print("success")
...
# main
s = gl.Service()
c = gl.Twenty20(s, timeout=6, refreshrate=refreshrate, verbose=True, 
